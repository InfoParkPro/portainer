...
type (
	...
	APIKey struct {
		...
		TemporaryAccessPreset    APIKeyAccessPreset `json:"temporaryAccessPreset,omitempty" example:"manage"`
		TemporaryAccessExpiresAt int64              `json:"temporaryAccessExpiresAt,omitempty" example:"1710000000"`
